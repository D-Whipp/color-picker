        ...
        function g(e, n, t) {
          ...
          var r,
            ...
            l = {
              x:
                ((i = t),
                (i.touches ? i.touches[i.touches.length - 1] : i)
                  .clientX),
              y:
                ((a = t),
                (a.touches ? a.touches[a.touches.length - 1] : a)
                  .clientY),
            },
            f = (l.x - o.x) / u,
            c = (l.y - o.y) / s;
    ...
    o = e(function (e, n) {
      e.exports = (function () {
        ...
        (c.namedColors = {}),
          ...
          (c.use = function (e) {
            return (
              -1 === c.pluginList.indexOf(e) &&
                (this.pluginList.push(e), e(c)),
              c
            );
          }),
        ...
        return c
              ...
              ['cyan', 'magenta', 'yellow', 'black', 'alpha'],
              {
                rgb: function () {
                  return new u.RGB(
                    ...
                    1 -
                      this._magenta * (1 - this._black) -
                      this._black,
                    1 -
                      this._yellow * (1 - this._black) -
                      this._black,
                    this._alpha
                  );
                },
          ...
          .use(function (t) {
            ...
            t.installMethod('greyscale', e).installMethod(
              'grayscale',
              e
            );
          })
          ...
          : function (e, n, t) {
              return (function (e) {
                ...
                function c(e) {
                  e = _(e) ? e : [];
                  for (
                    var n, t = f.change, r = 0, a = t.length;
                    r < a;
                    r++
                  )
